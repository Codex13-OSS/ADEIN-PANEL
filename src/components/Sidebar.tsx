...
const PropertyIcon = () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M4 21V8l8-5 8 5v13"/><path d="M9 21v-6h6v6"/><path d="M7 11h.01"/><path d="M17 11h.01"/></svg>;
...
const ownerNav: NavItem[] = [
  ...
  { key: 'properties', label: 'Propiedades', icon: <PropertyIcon /> },
